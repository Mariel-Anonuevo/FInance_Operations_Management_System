...
public class DashboardService : IDashboardService
{
    ...
    public async Task<DashboardSummaryDto> GetSummaryAsync()
    {
        ...
        var cashFlowBalance = await _context.CashFlowEntries.SumAsync(e => e.Type == "Inflow" ? e.Amount : -e.Amount);
    ...
    {
        var inflow = await _context.CashFlowEntries.Where(e => e.Type == "Inflow").SumAsync(e => e.Amount);
        var outflow = await _context.CashFlowEntries.Where(e => e.Type == "Outflow").SumAsync(e => e.Amount);
